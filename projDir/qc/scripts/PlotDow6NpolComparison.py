...
#===========================================================================
#
# Produce plots for comparison between DOW6 and NPOL
#
#===========================================================================
...
# parse the command line
    ...
    parser.add_option('--compFile',
                      dest='compFilePath',
                      default='/home/disk/meso-home/meso/projDir/data/olympex/radar_comparison/dow6_npol/DOW6_minus_NPOL_20151106_134817.summary.txt',
                      help='Comparison results file path')
    parser.add_option('--title',
                      dest='title',
                      default='COMPARISON DOW6 - NPOL',
                      help='Title for plot')
...
def doPlot(compData, compTimes):
    ...
    print >>sys.stderr, "DOW6-NPOL mean bias for project, Nov 12 - Dec 10: ", meanBiasProject
    ...
    ax1.set_xlabel("Date")
    ax1.set_ylabel("DOW6-NPOL DBZ BIAS (dB)")
    ax1.grid(True)
    # ax1.set_ylim([-5, 5])
